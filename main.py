...
from environment.helpers import read_yaml_file, load_env_config, RewardScalingWrapper
...
def main():
    # with open("config/data_driven_mpc_config.yaml", "r") as file:
    ...
    for var in change_list:
        params_controller_dict['controller'][var] = params_controller_dict['controller'][var][:DoF]
